...
public class IncidentWorker_Festival : IncidentWorker
{
    ...
    protected override bool TryExecuteWorker(IncidentParms parms)
    {
        ...
        site.AddPart(
            GetSitePartUtil.WithDefaultParams(SiteDefOfReconAndDiscovery.RD_Festival, site, tile, hostFaction));
        site.AddPart(GetSitePartUtil.WithDefaultParams(SiteDefOfReconAndDiscovery.RD_AbandonedColony, site, tile,
            hostFaction, true));
